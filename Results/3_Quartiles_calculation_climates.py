...
def main():
	...
	r = 1
	m = 10
	boxes0 = ax.boxplot(data_G, positions=[r+1 , r+m , r+2*m , r+3*m , r+4*m , r+5*m , r+6*m , r+7*m , r+8*m , r+9*m , r+10*m , r+11*m , r+12*m , r+13*m  ], showfliers=False,
							showmeans = True ,
	...
	'''------------------------------------'''
	data_A = [	
				df_A['SSPC_MBD'],		df_A['SSPC_RMSD'],	df_A['SSPC_MAPD'],	df_A['SSPC_MAD'],
			]
	data_B = [	
				df_B['SSPC_MBD'],		df_B['SSPC_RMSD'],	df_B['SSPC_MAPD'],	df_B['SSPC_MAD'],
			]
	data_C = [	
				df_C['SSPC_MBD'],		df_C['SSPC_RMSD'],	df_C['SSPC_MAPD'],	df_C['SSPC_MAD'],
			]
	data_D = [	
				df_D['SSPC_MBD'],		df_D['SSPC_RMSD'],	df_D['SSPC_MAPD'],	df_D['SSPC_MAD'],
			]
	data_E = [	
				df_E['SSPC_MBD'],		df_E['SSPC_RMSD'],	df_E['SSPC_MAPD'],	df_E['SSPC_MAD'],
			]
	data_G = [	
				df['SSPC_MBD'],		df['SSPC_RMSD'],		df['SSPC_MAPD'],	df['SSPC_MAD'],
			]
	...
	r = 1
	m = 7
	boxes0 = ax.boxplot(data_G, positions=[r , r+m , r+2*m , r+3*m  ], #showfliers=False,
							showmeans = True ,
	...
	c = "green"	
	r = 2
	boxes1 = ax.boxplot(data_A, positions=[r , r+m , r+2*m , r+3*m  ], #showfliers=False,
							showmeans = True ,
							meanprops={"marker": "o","markerfacecolor": "white","markeredgecolor": "black","markersize": "5" },
							labels=[	
								'' ,'' ,'' ,''
	...
	c = "purple"		
	r = 3
	boxes2 = ax.boxplot(data_B, positions=[r , r+m , r+2*m , r+3*m  ], #showfliers=False,
							showmeans = True ,
							meanprops={"marker": "o","markerfacecolor": "white","markeredgecolor": "black","markersize": "5" },
							labels=[	
								'MBD' , 'RMSD' ,'MAPD' ,'MAD'
	...
	c = "black"		
	r = 4
	boxes3 = ax.boxplot(data_C, positions=[r , r+m , r+2*m , r+3*m  ], #showfliers=False,
							showmeans = True ,
							meanprops={"marker": "o","markerfacecolor": "white","markeredgecolor": "black","markersize": "5" },
							labels=[	
								'' , '' ,'' ,''
	...
	c = "gray"		
	r = 5
	boxes4 = ax.boxplot(data_D, positions=[r , r+m , r+2*m , r+3*m  ], #showfliers=False,
							showmeans = True ,
							meanprops={"marker": "o","markerfacecolor": "white","markeredgecolor": "black","markersize": "5" },
							labels=[	
								'' , '' ,'' ,''
	...
	c = "orange"		
	r = 6
	boxes5 = ax.boxplot(data_E, positions=[r , r+m , r+2*m , r+3*m ], #showfliers=False,
							showmeans = True ,
							meanprops={"marker": "o","markerfacecolor": "white","markeredgecolor": "black","markersize": "5" },
							labels=[	
								'' , '' ,'' ,''
	...
	data_A_2 = [	
				df_A['SSPC_SBF'],	df_A['SSPC_NSE_o_R2'],	df_A['SSPC_WIA'],	df_A['SSPC_LCE'] 
			]
	data_B_2 = [	
				df_B['SSPC_SBF'],	df_B['SSPC_NSE_o_R2'],	df_B['SSPC_WIA'],	df_B['SSPC_LCE'] 
			]
	data_C_2 = [	
				df_C['SSPC_SBF'],	df_C['SSPC_NSE_o_R2'],	df_C['SSPC_WIA'],	df_C['SSPC_LCE'] 
			]
	data_D_2 = [	
				df_D['SSPC_SBF'],	df_D['SSPC_NSE_o_R2'],	df_D['SSPC_WIA'],	df_D['SSPC_LCE'] 
			]
	data_E_2 = [	
				df_E['SSPC_SBF'],	df_E['SSPC_NSE_o_R2'],	df_E['SSPC_WIA'],	df_E['SSPC_LCE'] 
			]
	data_G_2 = [	
				df['SSPC_SBF'],		df['SSPC_NSE_o_R2'],df['SSPC_WIA'],	df['SSPC_LCE'] 
			]
	...
	c = "blue"		
	r = 1
	boxes0 = ax.boxplot(data_G_2, positions=[r , r+m , r+2*m , r+3*m  ], #showfliers=False,
							showmeans = True ,
							meanprops={"marker": "o","markerfacecolor": "white","markeredgecolor": "black","markersize": "5" },
							labels=[	
								'' , '' ,'' ,''
	...
	c = "green"	
	r = 2
	boxes1 = ax.boxplot(data_A_2, positions=[r , r+m , r+2*m , r+3*m  ], #showfliers=False,
							showmeans = True ,
							meanprops={"marker": "o","markerfacecolor": "white","markeredgecolor": "black","markersize": "5" },
							labels=[	
								'' ,'' ,'' ,''
	...
	c = "purple"		
	r = 3
	boxes2 = ax.boxplot(data_B_2, positions=[r , r+m , r+2*m , r+3*m  ], #showfliers=False,
							showmeans = True ,
							meanprops={"marker": "o","markerfacecolor": "white","markeredgecolor": "black","markersize": "5" },
							labels=[	
								'SBF' ,'NSE' ,'WIA' ,'LCE' 
	...
	c = "black"		
	r = 4
	boxes3 = ax.boxplot(data_C_2, positions=[r , r+m , r+2*m , r+3*m  ], #showfliers=False,
							showmeans = True ,
							meanprops={"marker": "o","markerfacecolor": "white","markeredgecolor": "black","markersize": "5" },
							labels=[	
								'' , '' ,'' ,''
	...
	c = "gray"		
	r = 5
	boxes4 = ax.boxplot(data_D_2, positions=[r , r+m , r+2*m , r+3*m  ], #showfliers=False,
							showmeans = True ,
							meanprops={"marker": "o","markerfacecolor": "white","markeredgecolor": "black","markersize": "5" },
							labels=[	
								'' , '' ,'' ,''
	...
	c = "orange"		
	r = 6
	boxes5 = ax.boxplot(data_E_2, positions=[r , r+m , r+2*m , r+3*m ], #showfliers=False,
							showmeans = True ,
							meanprops={"marker": "o","markerfacecolor": "white","markeredgecolor": "black","markersize": "5" },
							labels=[	
								'' , '' ,'' ,''
